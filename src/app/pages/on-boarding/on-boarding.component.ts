...
export class OnBoardingComponent implements OnInit{
  ...
  images= [
    ...
    {src:"assets/onboardv2/editar_perfil/perfil_tatuador_blur.png", text:""},//0 //86
    {src:"assets/onboardv2/editar_perfil/perfil_tatuador_blur.png", text:""},//2n //88
    {src:"assets/onboardv2/editar_perfil/editar_perfil_final_blur.png", text:""},//4 //90
    {src:"assets/onboardv2/editar_perfil/editar_perfil_final_blur.png", text:""},//6 //92
    {src:"assets/onboardv2/editar_perfil/editar_perfil_final_noblur.png", text:""},//8 //94                      //segundo 10//
    
    {src:"assets/onboardv2/editar_perfil/perfil_tatuador_blur.png", text:""},//10 //96
    {src:"assets/onboardv2/editar_tienda/editar_tienda_final_blur.png", text:""},//12 //98
    {src:"assets/onboardv2/editar_tienda/editar_tienda_final_blur.png", text:""},//14 //100
    {src:"assets/onboardv2/editar_tienda/editar_tienda_final_noblur.png", text:""},//16 //102                         //segundo 18//

    
    {src:"assets/onboardv2/editar_perfil/perfil_tatuador_blur.png", text:""},//18 //104
    {src:"assets/onboardv2/editar_valoracion/valoracion_blur.png", text:""},//20 //106
    {src:"assets/onboardv2/editar_valoracion/valoracion_blur.png", text:""},//22 //108
    {src:"assets/onboardv2/editar_valoracion/valoracion_noblur.png", text:""},//24 //110                           //segundo 26//
    

    {src:"assets/onboardv2/editar_perfil/perfil_tatuador_blur.png", text:""},//26 //112
    {src:"assets/onboardv2/editar_galeria/galeria_blur.png", text:""},//28 //114
    {src:"assets/onboardv2/editar_galeria/galeria_blur.png", text:""},//30 //116
    {src:"assets/onboardv2/editar_galeria/galeria_noblur.png", text:""},//32 //118                                //segundo 34//


    {src:"assets/onboardv2/mod_perfil/mod_perfil_iniblur.png", text:""},//34 //120
    {src:"assets/onboardv2/mod_perfil/mod_perfil_iniblur.png", text:""},//36 //122
    {src:"assets/onboardv2/mod_perfil/mod_perfil_blur.png", text:""},//38 //124
    {src:"assets/onboardv2/mod_perfil/mod_perfil_blur.png", text:""},//40 //126
    {src:"assets/onboardv2/mod_perfil/mod_perfil_noblur.png", text:""},//42 //128                                 //segundo 44//


    {src:"assets/onboardv2/mod_perfil/mod_perfil_iniblur.png", text:""},//44 //130
    {src:"assets/onboardv2/mod_perfil_dato/editar perfil tatuador2_blur.png", text:""},//46 //132
    {src:"assets/onboardv2/mod_perfil_dato/editar perfil tatuador2_blur.png", text:""},//48 //134
    {src:"assets/onboardv2/mod_perfil_dato/editar perfil tatuador2_noblur.png", text:""},//50 //136                  //segundo 52//
